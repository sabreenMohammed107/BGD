                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('admin-clinic-gallery.destroy', $row) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('admin-clinic-gallery.store') }}"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <div>
                                ...
                                <select name="clinic_id" required aria-label="Select a clinic"
                                    data-control="select2"
                                    data-placeholder="Select a clinic..."
