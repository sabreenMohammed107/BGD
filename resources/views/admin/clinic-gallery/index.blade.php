                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-250px">clinic</th>
                                ...
                                <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                    <a href="#">
                                        ...
                                        <div class="symbol-label fs-3 bg-light-danger text-danger">
                                            <img src="{{ asset('uploads/galleries') }}/{{ $row->image }}" class="w-100"
                                                alt="">
                                        </div>
                                    </a>
                                </div>
                                    ...
                                    <div class="modal-content rounded">
                                        ...
                                        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                            ...
                                            <form id="kt_modal_update_target_updateForm" class="form"
                                                action="{{ route('admin-clinic-gallery.update', $row->id) }}"
                                                ...
                                                <div class="mb-7">
                                                    ...
                                                    <div class="mt-1">
                                                        ...
                                                        <div class="image-input image-input-outline"
                                                            ...
                                                            style="background-image: url(' {{ asset('uploads/galleries') }}/{{ $row->image }}')">
                                                ...
                                                <div class="d-flex flex-column mb-8 fv-row">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="clinic_id" required aria-label="Select a hotel"
                                                            data-control="select2" data-placeholder="Select a clinic..."
                                                            data-dropdown-parent="#kt_modal_new_targetEdit{{ $row->id }}"
                                                            class="form-select form-select-solid fw-bolder">
                                                            <option value=""></option>
                                                            @foreach ($clinics as $clinic)
                                                            <option value="{{ $clinic->id }}" {{ $row->clinic_id ==
                                                                $clinic->id ? 'selected' : '' }}>
                                                                {{ $clinic->name }}
                                                            </option>
                                                            @endforeach
                                                        ...
                                                        <div class="d-flex flex-column mb-8">
                                                            <div
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    name="active[]" value="1" id="flexSwitchDefault2" {{
                ...
                <form id="kt_modal_new_target_form" class="form" action="{{ route('admin-clinic-gallery.store') }}"
                    ...
                    <div class="d-flex flex-column mb-8 fv-row">
                        ...
                        <div>
                            ...
                            <select name="clinic_id" required aria-label="Select a clinic" data-control="select2"
                                data-placeholder="Select a clinic..." data-dropdown-parent="#kt_modal_new_target"
                                class="form-select form-select-solid fw-bolder">
                                <option value=""></option>
                                @foreach ($clinics as $clinic)
