    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Medical Field</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Medical Field</li>
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <form id="kt_modal_update_target_updateForm" class="form"
                                                        ...
                                                        <div class="mb-13 text-center">
                                                            <!--begin::Title-->
                                                            <h1 class="mb-3">Update Medical Field</h1>
                                                            <!--end::Title-->
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('medicine-fields.store') }}"
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Set Medical Field</h1>
                            <!--end::Title-->
