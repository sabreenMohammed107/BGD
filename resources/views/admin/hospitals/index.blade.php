    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Hospitals</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Hospitals</li>
...
@section('content')
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="#" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_new_target">Add Hospital</a>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('hospitals.destroy',$row->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <form id="kt_modal_update_target_updateForm" class="form"
                                                        action="{{ route('hospitals.update', $row->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PUT')
                                                        <!--begin::Heading-->
                                                        ...
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                                <span class="required">Hospital En Name</span>
                                                                <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                    data-bs-toggle="tooltip"
                                                                    title="Enter Hospital En Name"></i>
                                                            </label>
                                                            <!--end::Label-->
                                                            <input type="text" class="form-control form-control-solid"
                                                                placeholder="Enter En Hospital Name"
                                                                name="en_hospital"
                                                                value="{{ $row->en_hospital }}" />
                                                        </div>
                                                        <!--end::Input group-->
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            <!--begin::Label-->
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                                <span class="required">Hospital De Name</span>
                                                                <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                    data-bs-toggle="tooltip"
                                                                    title="Enter Hospital De Name"></i>
                                                            </label>
                                                            <!--end::Label-->
                                                            <input type="text" class="form-control form-control-solid"
                                                                placeholder="Enter De Country Name"
                                                                name="dt_hospital"
                                                                value="{{ $row->dt_hospital }}" />
                                                        </div>
                                                        <!--end::Input group-->
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('hospitals.store') }}"
                        ...
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Set Hospital Name</h1>
                            <!--end::Title-->
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input type="text" class="form-control form-control-solid"
                                placeholder="Enter Hospital En Name" name="en_hospital" />
                        </div>
                        <!--end::Input group-->
   ...
   <div class="d-flex flex-column mb-8 fv-row">
    ...
    <!--end::Label-->
    <input type="text" class="form-control form-control-solid"
        placeholder="Enter Hospital De Name" name="dt_hospital" />
</div>
<!--end::Input group-->
