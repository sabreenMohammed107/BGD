    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Medical Sub Field</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Medical Sub Field</li>
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label fs-3 bg-light-danger text-danger">
                                                    <img src="{{ asset('uploads/medical_sub_fields') }}/{{ $row->field_img }}"
                                                        class="w-100" alt="">
                                                </div>
                                            </a>
                                        </div>
...
<input type="hidden" name="" id=""  data-kt-ecommerce-category-filter="category_id" value="{{$row->id}}" >
                                            ...
                                            <span class="symbol-label">{{ $row->field_enoverview }}</span>
                                    ...
                                    {{-- <td>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <span class="symbol-label">{{ $row->field_dtoverview }}</span>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                ...
                                                <form id="delete_{{ $row->id }}"
                                                    action="{{ route('medicine-sub-fields.destroy', $row) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <div class="modal-content rounded">
                                                ...
                                                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                                                    ...
                                                    <form id="kt_modal_update_target_updateForm" class="form"
                                                        action="{{ route('medicine-sub-fields.update', $row->id) }}"
                                                        ...
                                                        <div class="mb-13 text-center">
                                                            <!--begin::Title-->
                                                            <h1 class="mb-3">Update Medical Sub Field</h1>
                                                            <!--end::Title-->
                                                        ...
                                                        <div class="mb-7">
                                                            ...
                                                            <div class="mt-1">
                                                                ...
                                                                <div class="image-input image-input-outline"
                                                                    ...
                                                                    style="background-image: url(' {{ asset('uploads/medical_sub_fields') }}/{{ $row->field_img }}')">
                                                        ...
                                                        <!--end::Label-->
                                                        <select name="medical_field_id" aria-label="Select  Medical Field"
                                                            data-control="select2"
                                                            data-placeholder="Select  Medical Field..."
    ...
    <div class="modal fade" id="kt_modal_new_target" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('medicine-sub-fields.store') }}"
                        method="post" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            <!--begin::Title-->
                            <h1 class="mb-3">Set Medical Sub Field</h1>
                            <!--end::Title-->
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <select name="medical_field_id" aria-label="Select a Country" data-control="select2"
                        ...
                        <div class="d-flex flex-column mb-8">
                            <label class="fs-6 fw-bold mb-2">Field En Overview</label>
                            <textarea class="form-control form-control-solid" rows="3" name="field_enoverview"
                                placeholder="Type Field En Overview"></textarea>
                        </div>
                        <!--end::Input group-->
