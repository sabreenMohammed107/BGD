    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Admin Users </h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="card card-flush">
                ...
                <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Add customer-->
                      	<!--begin::Add product-->
											<a href="{{ route('all-admins.create') }}" class="btn btn-primary">Add User</a>
											<!--end::Add product-->
                       ...
                       <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
                        ...
                        <thead>
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="text-end min-w-70px">Permission</th>
     ...
     <tr>
        ...
        <td class="text-end pe-0" data-order="15">
            <span class="fw-bolder ms-3">{{ $row->is_super==false ? 'Admin' : 'Support'}}</span>
        </td>
        <!--end::Qty=-->
        ...
        <td class="text-end">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                ...
                <div class="menu-item px-3">
                    <a href="{{ route('all-admins.edit', $row->id) }}"
        ...
        <form id="delete_{{$row->id}}" action="{{ route('all-admins.destroy', $row->id) }}"  method="POST" style="display: none;">
        @csrf
        @method('DELETE')
