                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select form-select-solid" name="doctor_id"
                                                ...
                                                <option value="{{ $doctor->id }}" {{ $row->doctor_id == $doctor->id ?
                                                    'selected' : '' }}>
                                                    {{ $doctor->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <select class="form-select form-select-solid" name="city_id"
                                                ...
                                                <option value="{{ $city->id }}" {{ $row->city_id == $city->id ?
                                                    'selected' :
                                                    '' }}>
                                                    {{ $city->en_city }}
                                                </option>
                                        ...
                                        <div>
                                            ...
                                            <div id="hidden_div">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <input type="text" id="visit_fees" name="visit_fees"
                                                    class="form-control mb-2" placeholder="visit_fees"
                                                    value="{{ $row->visit_fees }}" />
                                                <!--end::Editor-->
