    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">Cancelled Reservations</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">Cancelled Reservations</li>
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            ...
            <div id="preIndex" class="card card-flush">
                <!--begin::Card header-->
                @include('admin.reservation.subCancelled')
...
@section('scripts')
    <script>
        $('#search-form').on('submit', function(e) {
            ...
            if (name == "admin") {
                var url = "{{ route('admin.cancelled-reservation-filter') }}";

            } else {
                var url = "{{ route('doctor.cancelled-reservation-filter') }}";
            }
            e.preventDefault();
            $.ajax({
                type: 'GET',
