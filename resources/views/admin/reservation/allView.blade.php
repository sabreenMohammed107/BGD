...
@endif </div>
                    ...
                    <div class="modal fade" id="confReservation{{ $row->id }}" tabindex="-1"
                        aria-hidden="true">
                        <!--begin::Modal dialog-->
...
<div class="mb-10 fv-row">
    ...
    <!--end::Label-->
    <!--begin::Input-->
    <input type="text" disabled name="name" value="{{$row->patient->name ?? ''}}" class="form-control mb-2" placeholder="name"
        value="" />
