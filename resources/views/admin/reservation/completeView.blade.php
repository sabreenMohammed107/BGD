...
<!--end::Aside column-->
 ...
 <div class="mb-10 fv-row">
    ...
    <!--end::Label-->
    <!--begin::Input-->
    <input type="text" name="mobile"  @if ( $row->other_flag == 1)
    value="{{$row->patient_address}}"
                                 @else
                                 value="{{$row->patient->details_address ?? ''}}"
                                @endif  class="form-control mb-2" placeholder="details_address"
        value="" />
...
<!--end::Input group-->
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('admin.complete-reservations') }}" id="kt_ecommerce_add_product_cancel"
                    ...
                    <div class="d-flex justify-content-end">
                        <!--begin::Button-->
                        <a href="{{ route('doctor.complete-reservations') }}" id="kt_ecommerce_add_product_cancel"
                            class="btn btn-light me-5">Cancel</a>
                        <!--end::Button-->
                        <!--begin::Button-->
