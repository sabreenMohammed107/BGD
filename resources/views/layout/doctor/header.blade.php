                    ...
                    {{-- <div id="kt_header_search" class="d-flex align-items-center w-100 w-lg-300px"
                        ...
                        <form data-kt-search-element="form" class="d-none d-lg-block w-100 mb-5 mb-lg-0"
                            ...
                            <div class="position-relative d-flex align-items-center">
                                ...
                                <!--end::Icon-->
                                <!--begin::Input-->
                                <input type="text" class="search-input form-control form-control-transparent ps-8"
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">
                                            ...
                                            <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{
                                                Auth::guard('doctor')->user()->mobile ?? '' }}</span>
                                        </div>
                                        <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{
                                            Auth::guard('doctor')->user()->email ?? '' }}</a>
                                    </div>
                                    <!--end::Username-->
                                </div>
                            </div>
                    ...
                    <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-35px symbol-lg-35px" data-kt-menu-trigger="click"
                            ...
                            <div class="notification-icon right" id="countNotify">
                            ...
                            background: #f00;
                            border-radius: 50%;">
                            {{ count(Auth::guard('doctor')->user()->unreadNotifications) }}
                        </span>
                            </div>
                        </div>
                        <!--begin::User account menu-->
                        <div id="dropNotify" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            data-kt-menu="true">
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bolder d-flex align-items-center fs-5">
                                            Notifications <span
                                                class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2 count">{{
                                                count(Auth::guard('doctor')->user()->unreadNotifications) }}</span>
                            ...
                            <div class="fw-bolder d-flex align-items-right fs-5" style="justify-content: flex-end;">
                                ...
                                <a style="color:#7c7c7c;font-size:12px;padding-right: 10px"
                                    href="{{ route('markAllRead') }}">Show all</a>
                            </div>
                            <div class="separator my-2"></div>
                            <!--end::Menu separator-->
                            @php
                            ...
                            @if($loop->last)
                            <a href="{{ route('markAllRead') }}" id="mark-all" style="padding-left: 10px">Mark all as
                                read</a>
                            @endif
                            @else
                    ...
                    <div class="d-flex align-items-center ms-2 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        <div class="cursor-pointer symbol symbol-35px symbol-lg-35px" data-kt-menu-trigger="click"
                            ...
                            <img alt="Pic"
                                src="{{ asset('uploads/doctors') }}/{{ Auth::guard('doctor')->user()->img }}" />
                        </div>
                        <!--begin::User account menu-->
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                            data-kt-menu="true">
                            ...
                            <div class="menu-item px-5">
                                ...
                                {{-- <a href="../dist/authentication/flows/basic/sign-in.html"
                                            ...
                                            <div class="carousel-inner pt-6">
                                                    ...
                                                    <div class="carousel-wrapper">
                                                        <div
                                                            ...
                                                            <a href=""
                                                                ...
                                                                Admin Launch Day</a>
                                                            <p class="text-gray-600 fs-6 fw-bold pt-4 mb-0">To start a
                                                                blog, think of a topic about and first brainstorm ways
                                                                to write details</p>
                                                        </div>
                                                        <!--begin::Info-->
                                                ...
                                                <div class="carousel-item">
                                                    <div class="carousel-wrapper">
                                                        ...
                                                        <div class="d-flex flex-stack pt-8">
                                                            <span
                                                                class="badge badge-light-primary fs-7 fw-boldest me-2">NOV
                                                                06, 23</span>
                                                            <a href="#"
                                                                class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5"
                                                                data-bs-toggle="modal"
                                                ...
                                                <div class="carousel-item">
                                                    <div class="carousel-wrapper">
                                                        ...
                                                        <div class="d-flex flex-stack pt-8">
                                                            <span
                                                                class="badge badge-light-primary fs-7 fw-boldest me-2">AUG
                                                                01, 13</span>
                                                            <a href="#"
                                                                class="btn btn-light btn-sm btn-color-muted fs-7 fw-boldest px-5"
                                                                data-bs-toggle="modal"
                                            ...
                                            <div class="carousel-inner pt-8">
                                                ...
                                                <div class="carousel-item">
                                                    <div class="carousel-wrapper">
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="d-flex flex-stack pt-7">
                                                            <span class="text-gray-400 fs-6 fw-bold pe-2">745 R St.
                                                                Romance DR..</span>
                                                            <a href="#"
                                                                class="btn btn-light btn-sm fs-7 btn-color-muted fw-boldest px-5"
                                                                data-bs-toggle="modal"
                                                ...
                                                <div class="carousel-item">
                                                    <div class="carousel-wrapper">
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="d-flex flex-stack pt-7">
                                                            <span class="text-gray-400 fs-6 fw-bold pe-2">123 R St.
                                                                Soulard NY..</span>
                                                            <a href="#"
                                                                class="btn btn-light btn-sm fs-7 btn-color-muted fw-boldest px-5"
                                                                data-bs-toggle="modal"
                                ...
                                <div class="mt-n20 pb-5 position-relative zindex-1">
                                    ...
                                    <div class="d-flex flex-stack mb-6">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div>
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-boldest">Global
                                                    Stars</a>
                                    ...
                                    <div class="d-flex flex-stack mb-6">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div>
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-boldest">Focus
                                                    Keeper</a>
                                    ...
                                    <div class="d-flex flex-stack mb-">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <div>
                                                <a href="#"
                                                    class="fs-5 text-gray-800 text-hover-primary fw-boldest">High
                                                    Tower</a>
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <div>
                                                    <select class="form-select form-select-solid" data-kt-select2="true"
                                                        ...
                                                        data-dropdown-parent="#kt_menu_620f4415223d2"
                            ...
                            <div class="card-body pt-4">
                                <div class="position-relative">
                                    ...
                                    <div class="w-35px d-flex justify-content-center">
                                        <div
                                            class="border-start border-1 border-dashed border-gray-300 top-0 bottom-0 mb-5 mt-5 position-absolute">
                                        </div>
                                    </div>
                                    <!--end::Border-->
                                    <!--begin::Item-->
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="pe-3">
                                                ...
                                                <div class="text-gray-400 fw-bold mt-1">New
                                                    <a href="#" class="link-primary p-1">Author Account</a>with
                                                    Affiliate
                                                </div>
                                            </div>
                                            <!--end::Title-->
