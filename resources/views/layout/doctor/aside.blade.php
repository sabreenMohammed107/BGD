...
<div id="kt_aside" class="aside aside-default aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-logo flex-column-auto pt-9 pb-5" id="kt_aside_logo">
        <!--begin::Logo-->
        <a href="#">
            <img alt="Logo" src="{{ asset('uploads/data') }}/{{ $data->logo }}" class="max-h-50px logo-default "
                style="height: 120px" />
            <img alt="Logo" src="{{ asset('uploads/data') }}/{{ $data->logo }}" class="max-h-50px logo-minimize "
                style="height: 120px" />
        </a>
        <!--end::Logo-->
    </div>
            ...
            <div class="menu-fit hover-scroll-y me-lg-n5 pe-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                ...
                <div class="menu-item ">
                    <div class="menu-content">
                        <span class="fw-bold text-muted text-uppercase fs-7">Reservations</span>
                    </div>
                </div>
                ...
                <!-- start Doctors -->
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('doctor.all-reservations') }}">
                ...
                <!-- start Doctors -->
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('doctor.cancelled-reservations') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <!-- start Doctors -->
                <div class="menu-item">
                    <a class="menu-link" href="{{ route('doctor-clinics.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu-item">
                    ...
                    @endphp
                    <a class="menu-link" href="{{ route('doctor-profile', $docId) }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/abstract/abs042.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
